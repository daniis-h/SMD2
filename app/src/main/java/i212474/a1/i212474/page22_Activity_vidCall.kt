...
class page22_Activity_vidCall : AppCompatActivity() {
    ...
    private val token = "007eJxTYFh6/MSfM9eiLC+9CJ+mc86vo3WD1hc79mrPxETPaUsnBkopMFimpJikWaSmmRklmpmYGaRamCWbWaYaGZmampubGRkb5aZzpTUEMjKY3LvMwsgAgSA+O4NzRmJeXmoOAwMAAz4gmg=="
    private var uid =0
    var isJoined = false
